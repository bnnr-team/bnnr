...
Supported tasks (**v0.5.7**): single-label classification, multi-label classification, and object detection (COCO-mini / YOLO). See [Documentation](https://github.com/bnnr-team/bnnr/blob/main/docs/README.md).<!-- x-release-please-version -->
