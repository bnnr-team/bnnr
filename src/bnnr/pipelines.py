...
Supported datasets: mnist, fashion_mnist, cifar10, imagefolder.
"""
...
_SUPPORTED_DATASETS = ("mnist", "fashion_mnist", "cifar10", "imagefolder")
...
def build_pipeline(
    ...
    **kwargs: Any,
    ...
    ----------
    dataset_name:
        One of: mnist, fashion_mnist, cifar10, imagefolder.
    config:
        BNNR configuration.
    data_dir:
