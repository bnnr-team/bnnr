...
If you use BNNR in research, a report, or a downstream integration guide, cite the appropriate entry below. Pin a [release tag](https://github.com/bnnr-team/bnnr/releases) (for example `v0.5.3`) when you need a fixed software version. <!-- x-release-please-version -->
