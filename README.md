...
BNNR core remains free and open source under the MIT license.
Paid offerings are planned around value-added services, including:
- managed cloud hosting,
- enterprise support and SLA,
- production integrations and customer deployments.
